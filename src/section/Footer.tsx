export default function Footer() {
  return (
    <footer className="bg-gradient-to-r from-slate-700 via-slate-600 to-slate-700 text-white py-12">
          ...
          <div className="md:col-span-2">
            <div className="flex flex-col gap-2 mb-4">
              <div className="flex items-center gap-4">
                <img src="/logo2.svg" alt="Dev Flow Logo" className="h-12 w-auto" style={{ filter: 'invert(1)' }} />
                <img src="/q.svg" alt="Q Logo" className="h-12 w-auto" style={{ filter: 'invert(1)' }} />
              </div>
              <p className="text-gray-300">
                Where ideas become scalable digital solutions. We specialize in modern web development,
                mobile apps, and innovative technology solutions.
              </p>
            </div>
